...
export default {
  ...
  setup (props) {
    ...
    const changeCity = (shippingAddress) => {
      provinceCode.value = shippingAddress.provinceCode
      cityCode.value = shippingAddress.cityCode
      countyCode.value = shippingAddress.countyCode
      fullLocation.value = shippingAddress.fullLocation
    }
